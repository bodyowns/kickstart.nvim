    ...
    { "L3MON4D3/LuaSnip" },        -- Snippet engine
	{
		...
		config = function()
			require("harpoon").setup({
				...
				menu = {
					width = 100, -- Width of the Harpoon menu
					height = 40, -- Width of the Harpoon menu
				},
			})
...
cmp.setup({
    ...
    mapping = {
        ...
        ['<F12>'] = cmp.mapping.complete(), -- Trigger completion with .
    },
    sources = {
        { name = "nvim_lsp" },
        { name = "buffer" },
...
-- Setup LSP server for Python
--local lspconfig = require("lspconfig")
--lspconfig.pyright.setup{}
local lspconfig = require("lspconfig")
lspconfig.pylsp.setup{
    cmd = { "C:\\Users\\SebastianX.Noje\\AppData\\Scripts\\polars\\env\\Scripts\\pylsp.exe" } -- Adjust the path accordingly
}
